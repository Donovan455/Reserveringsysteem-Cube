...
$default_language   = "language_dutch.php";

// Image Verification Feature -------------------------------------------------------

$image_verify       = 3;      // Set to 1 for simple, or 2 for Recaptcha Version 1.0
...
$recaptcha_public_key = "6LfEzDYUAAAAAHTpymqKho97fUc3xdKJq3oeKvrZ";	  // Recaptcha Public Key obtained from google.com/recaptcha
$recaptcha_private_key = "6LfEzDYUAAAAAAc30RFtrKlleqr9k8ZuryDNecth";  // Recaptcha Private Key obtained from google.com/recaptcha
                              
// Admin Interface Username ---------------------------------------------------------

$_Username         = "admin";
$_Password         = "multisant12";
...
$referers = array (
  'cubevastgoed.nl',           // Your domain name without WWW
  'www.cubevastgoed.nl',       // Your domain name with WWW
